              ...
              >
                ...
                >
                  ...
                  <motion.div variants={itemVariants} className="text-white">
                    ...
                    <Link href="/catalog" className="block py-2 text-gray-300 hover:text-white">
                      Browse All
                    </Link>
                  </motion.div>
                  ...
                  <motion.div variants={itemVariants} className="text-white">
                    ...
                    <Link href="/process" className="block py-2 text-gray-300 hover:text-white">
                      How We Work
                    </Link>
                    <Link href="/process/timeline" className="block py-2 text-gray-300 hover:text-white">
                      Project Timeline
                    </Link>
                  </motion.div>
                  ...
                  <motion.div variants={itemVariants} className="text-white">
                    ...
                    <Link href="/science-centers" className="block py-2 text-gray-300 hover:text-white">
                      Science Centers
                    </Link>
                    <Link href="/museums-parks" className="block py-2 text-gray-300 hover:text-white">
                      Children&apos;s Museums & Parks
                    </Link>
                    <Link href="/planetariums" className="block py-2 text-gray-300 hover:text-white">
                      Museums & Planetariums
                    </Link>
                    <Link href="/brand-experiences" className="block py-2 text-gray-300 hover:text-white">
                      Brand Experiences
                    </Link>
                    <Link href="/art" className="block py-2 text-gray-300 hover:text-white">
                      Art
                    </Link>
                    <Link href="/product-development" className="block py-2 text-gray-300 hover:text-white">
                      Product Development
                    </Link>
                  </motion.div>
